...
//           `${import.meta.env.VITE_SERVER_URL}/dashboard/stats`
//         );

//         // Fetch recent products
//         const productsRes = await axios.get(
//           `${import.meta.env.VITE_SERVER_URL}/products?limit=6&sort=newest`
//         );
...
//   // Key features for garment factories
//   const features = [
//     {
...
//   // Testimonials from garment factory owners
//   const testimonials = [
//     {
//       id: 1,
...
//   const recentProducts = products.length > 0 ? products : [
//     {
//       _id: "1",
...
//                   Trusted by {stats.factories}+ Garment Factories
//                 </span>
//               </motion.div>
...
//               >
//                 {[
//                   { label: "Active Orders", value: stats.activeOrders, icon: <FaClipboardCheck /> },
//                   { label: "Completed", value: stats.completedOrders, icon: <FaCheckCircle /> },
//                   { label: "Factories", value: stats.factories, icon: <FaIndustry /> },
//                   { label: "Monthly Revenue", value: `$${stats.monthlyRevenue.toLocaleString()}`, icon: <FaDollarSign /> },
//                 ].map((stat, index) => (
//                   <motion.div
//                     key={index}
//                     initial={{ opacity: 0, y: 20 }}
    ...
    const fetchDashboardData = async () => {
      try {
        ...
        const [statsRes, productsRes] = await Promise.all([
          axios.get(`${import.meta.env.VITE_SERVER_URL}/dashboard/stats`).catch(() => ({ data: { success: false } })),
          axios.get(`${import.meta.env.VITE_SERVER_URL}/products?limit=6&sort=newest`).catch(() => ({ data: { success: false } })),
        ]);
