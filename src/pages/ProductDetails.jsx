...
// import { FaHeart, FaShare, FaShoppingCart, FaBox, FaExclamationTriangle, FaTag, FaShippingFast } from 'react-icons/fa';
...
//   const outOfStockText = !isInStock ? 'Out of Stock' :
//                         isLowStock ? `Only ${product.quantity} left!` :
...
//                     <p className="mt-2">This product is currently unavailable</p>
//                   </div>
//                 </div>
//               )}
...
//                   className={`btn btn-circle ${wishlisted ? 'btn-error' : 'btn-ghost bg-white/90 hover:bg-white'}`}
//                   title={wishlisted ? 'Remove from Wishlist' : 'Add to Wishlist'}
//                 >
//                   <FaHeart className={wishlisted ? 'text-white' : 'text-gray-700'} />
//                 </button>
...
//               {/* Stock Status Badge */}
//               <div className={`badge badge-lg ${!isInStock ? 'badge-error' : isLowStock ? 'badge-warning' : 'badge-success'}`}>
...
//                   </div>
//                   <progress
//                     className={`progress w-full ${product.quantity <= 10 ? 'progress-warning' : product.quantity <= 30 ? 'progress-info' : 'progress-success'}`}
...
//                 <div className={`stat-value ${!isInStock ? 'text-error' : isLowStock ? 'text-warning' : 'text-success'}`}>
//                   {product.quantity}
//                 </div>
...
//                   {product.paymentOptions === 'cashOnDelivery' ? 'Cash on Delivery' : 'Pay First'}
//                 </div>
//               </div>

//               <div className="stat bg-base-200 rounded-lg p-4">
//                 <div className="stat-title">Category</div>
//                 <div className="stat-value text-lg capitalize">{product.category}</div>
//               </div>
//             </div>
...
//                           <span className="ml-2">Estimated delivery 5-7 business days</span>
//                         </div>
//                       </div>
//                     </>
//                   ) : (
...
//                           <p className="text-sm mt-1">Check back later or contact us for restock updates.</p>
//                         </div>
//                       </div>
...
//                     <div>
//                       <span>
//                         {user.role === 'admin' ? 'Admin' : 'Manager'} cannot place orders.
//                         {user.role === 'manager' && (
//                           <Link to={`/dashboard/manage-products/${product._id}/edit`} className="link link-primary ml-2">
//                             Edit this product
//                           </Link>
//                         )}
//                       </span>
...
//                     Please <Link to="/login" className="link link-primary font-semibold">login</Link> to place an order.
//                   </p>
...
//                   <span className="font-medium ml-2">{product.createdBy?.name || 'Admin'}</span>
//                 </div>
//                 <div>
...
//                   <span className={`badge ml-2 ${product.showOnHome ? 'badge-success' : 'badge-ghost'}`}>
...
//               return (
//                 <div key={relatedProduct._id} className="card bg-base-100 shadow-md hover:shadow-lg transition-shadow">
...
//                       <span className={`badge ${isRelatedInStock ? 'badge-success' : 'badge-error'}`}>
//                         {isRelatedInStock ? 'In Stock' : 'Out of Stock'}
//                       </span>
//                     </div>
//                   </figure>
//                   <div className="card-body p-4">
//                     <h3 className="card-title text-sm font-bold">{relatedProduct.title}</h3>
//                     <p className="text-primary font-bold">${relatedProduct.price}</p>
//                     <p className="text-sm text-gray-600">
//                       {isRelatedInStock ? `${relatedProduct.quantity} units available` : 'Not available'}
//                     </p>
//                     <div className="card-actions justify-end mt-2">
//                       <Link
//                         to={`/products/${relatedProduct._id}`}
//                         className={`btn btn-sm ${isRelatedInStock ? 'btn-primary' : 'btn-error btn-disabled'}`}
//                       >
//                         View Details
//                       </Link>
//                     </div>
